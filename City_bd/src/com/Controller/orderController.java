...
public class orderController {
	...
	// 分页查询
	@RequestMapping("/list")
	public String selList(CityOrder o,int index,Map map){
		// 分页功能类
		pageUtil<CityOrder> p = new pageUtil<CityOrder>();
		int size = 10;// 每页数据量
		
		List<CityOrder> list = dao.selList(o.getShopsid(),o.getOrderNumber(),o.getTypeid(),(index-1)*size,size);
		// 获取总页数
		int count = dao.count(o.getShopsid(),o.getOrderNumber(),o.getTypeid());
		// 计算总页数
